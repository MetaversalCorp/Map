...
MAP_OBJECT_LIGHT::MAP_OBJECT_LIGHT (uint16_t wClass_Parent, uint64_t twParentIx, uint16_t wClass_Object, uint64_t twObjectIx) :
   MAP_OBJECT (wClass_Parent, twParentIx, wClass_Object, twObjectIx)
{
}

MAP_OBJECT_LIGHT::MAP_OBJECT_LIGHT (const MAP_OBJECT_POD& Pod) :
   MAP_OBJECT (Pod)
{
}
